    ...
    return (
        <GuestLayout>
            ...
            <form onSubmit={submit}>
                <div>
                    <InputLabel htmlFor="email" value="Correo o Nombre de usuario" />
            ...
            <div className="text-center py-3 text-gray-400 uppercase">QuiliPos v{version}</div>
            </div>

            <div className='flex justify-center'>
                <img src={quiliposLogo} alt="QuiliPos" style={{height:'80px', objectFit:'contain'}}/>
            </div>
